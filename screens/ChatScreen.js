...
export default class Exchange extends Component{
  ...
  render(){
    return(
      <View style={{flex:1}}>
      <MyHeader title="Chat"/>
      <KeyboardAvoidingView style={{flex:1,justifyContent:'center', alignItems:'center', backgroundColor:'black'}}>
        <TextInput
        ...
        <TouchableOpacity
          ...
          >
          <Text style={{color:'white', fontSize:18, fontWeight:'bold'}}>Enter</Text>
        </TouchableOpacity>
